...
export const SidebarTab = (props: SidebarTabProps) => {
    ...
    return (
        <div className={"absolute w-96 h-full p-4 bg-white border-r-2 border-gray-300 flex flex-col gap-2 " + (sidebarState == props.state && isSidebarVisible ? "" : "-translate-x-full")} style={{zIndex: 1}}>
